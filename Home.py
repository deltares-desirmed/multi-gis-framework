...
st.markdown(
    ...
    The platform integrates **on-the-fly web-mapping and decision-support** based on globally recognized datasets. For region-specific, higher-resolution customised analyses and Pathways, please refer to the dedicated such as [WebGIS](https://github.com/deltares-desirmed), and [QuickScan tool](https://github.com/deltares-desirmed).
    *Note: The datasets used here are coarser. 
...
st.markdown(
    """
    For region-specific, higher-resolution customised analyses and Pathways, please refer to the dedicated such as [WebGIS](https://github.com/deltares-desirmed), and [QuickScan tool](https://github.com/deltares-desirmed).
