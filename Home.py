...
st.markdown(
    ...
    *Note: The datasets used here are coarser. For region-specific, higher-resolution customised analyses and Pathways, please refer to the dedicated [WebGIS] (https://github.com/deltares-desirmed)  and **[QuickScan tool]** (https://github.com/deltares-desirmed).* 
