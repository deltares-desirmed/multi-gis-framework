...
if uploaded:
    ...
    try:
        ...
        if uploaded_fc:
            ...
            st.error("❌ Uploaded shapefile could not be parsed. Make sure it includes `.shp`, `.shx`, `.dbf`.")
...
if final_aoi:
    try:
        ...
        Map.addLayer(aoi_fc.style(color='red', fillColor='00000000', width=2), {}, "AOI Boundary")
    ...
    st.warning("⚠️ Please select or upload a valid AOI.")
